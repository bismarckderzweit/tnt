...
${UNCRUSTIFYBIN} -c /Users/kit/Documents/ITK/InsightToolKit/Utilities/Maintenance/uncrustify_itk.cfg -l CPP -f ${file} | sed 's/  *##  */##/g' | sed 's/#  */#/g' > ${file}_uncrustify
...
KWSTYLE_EXECUTABLE-NOTFOUND -xml /Users/kit/Documents/ITK/ITKbin/Utilities/KWStyle/ITK.kws.xml -v -o /Users/kit/Documents/ITK/InsightToolKit/Utilities/KWStyle/ITKOverwrite.txt -gcc $file > ${KWERRORS}
...
if [ -f ${KWERRORS} ]; then
  ...
  if [ ${skipuncrustify} == "y" ]; then
    ${UNCRUSTIFYBIN} -c /Users/kit/Documents/ITK/InsightToolKit/Utilities/Maintenance/uncrustify_itk.cfg -l CPP -f ${file} -o ${KWERRORS}_skip_uncrustify
  fi
